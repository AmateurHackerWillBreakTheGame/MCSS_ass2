...
public class Params {
	...
	public static final int WHITE_PORTION = 20; // 0% to 100%
	public static final double BLACK_ALBEDO = 0.25; // 0 to 1
	public static final double WHITE_ALBEDO = 0.75; // 0 to 1
	public static final double SURFACE_ALBEDO = 0.6; // 0 to 1
	public static double solar_luminosity = 0.6; // 0 to 3
	public static double global_tempreature = 0.0;
	public static ScenarioType scenario = ScenarioType.ramp_up_ramp_down;
